//===-- Engine.h - Wolfram Engine Wrapper Interface------------------------===//
//
// This is a minimal interface wrapping the WSTP C API to provide a friendlier
// way to interact with a Wolfram Engine Kernel from C.
//
//===----------------------------------------------------------------------===//
...
CLEANUP:
  /* printf("Failed to create ELEngine (WSError %d)\n", error); */
  free(engine);
  return NULL;
}
